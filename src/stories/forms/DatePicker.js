                        ...
                        <div className="container mx-auto px-4 py-2 md:py-10">
                                ...
                                <div className="relative">
                                    <input type="hidden" name="date" x-ref="date">
                                        ...
                                        <span x-text="MONTH_NAMES[month]"
                                              className="text-lg font-bold text-gray-800"></span>
                                                <span x-text="year"
                                                      className="ml-1 text-lg text-gray-600 font-normal"></span>
                                            </div>
                                            <div>
                                                <button
                                                    type="button"
                                                ...
                                                <svg className="h-6 w-6 text-gray-500 inline-flex" fill="none"
                                                     viewBox="0 0 24 24"
                                                     stroke="currentColor">
                            ...
                            <div className="flex flex-wrap mb-3 -mx-1">
                                ...
                                <div style="width: 14.26%" className="px-1">
                                    <div
                                        x-text="day"
                                        className="text-gray-800 font-medium text-center text-xs"></div>
                                </div>
                            </template>
                        </div>
